		...
		createIt: function(options){
			...
			var handler = {
				...
				_checkCode: function(){
					...
					var postdata = {
						zakat_id: $('#zakat-id').val(),
						code: $('#code').val()
					}
					
					LumiRequest.sendApi({
						url: options.baseUrl + 'zakat/checkCode',
						postdata: postdata,
						success: success,
						error: error
					});
				...
				_save: function(){
					...
					var success = function(response){
						if(response.status == 'OK'){
							...
							alertMessage('success', 'Simpan zakat berhasil');
							location.href = options.baseUrl + 'zakat';
					...
					LumiRequest.sendApi({
						url: options.baseUrl + 'zakat/save',
						postdata: postdata,
						success: success,
						error: error
					});
